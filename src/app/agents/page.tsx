...
export default function AgentsPage() {
    ...
    setChats((p) => ({
      ...
      [agentId]: [
        ...(p[agentId] || [
          {
            role: "agent",
            text: `Hi! I'm ${agent.name}. ${agent.desc} Ask me anything!`,
          },
        ]),
        userMsg,
      ],
  ...
  return (
    ...
    >
        ...
        <div className="w-full flex items-center justify-between px-4">
          <div>
            ...
            >
              ...
              · Click any card to open live chat
            </p>
          </div>
          <Link
      ...
      <div
        className="w-full px-4 py-6 flex gap-5"
        style={{ minHeight: "calc(100vh - 130px)" }}
      >
        {/* Agent grid */}
        <div
          className={`grid gap-4 content-start transition-all ${activeAgent ? "w-[340px] shrink-0 grid-cols-1" : "flex-1 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"}`}
        >
          {AGENTS.map((agent) => {
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle at top right, ${agent.color}06, transparent 60%)`,
                  }}
                />
                ...
                <div className="flex items-start justify-between mb-3 relative">
                  ...
                  <div className="flex items-center gap-1.5">
                    <span
                      className={`w-2 h-2 rounded-full ${agent.status === "online" ? "bg-green-400" : "bg-amber-400"}`}
                      style={{
                        boxShadow: `0 0 6px ${agent.status === "online" ? "#22c55e" : "#f59e0b"}`,
                      }}
                    />
                    <span
                ...
                <div className="relative">
                  <div
                    ...
                    style={{ color: isActive ? agent.color : T.headerColor }}
                  >
                    {agent.name}
                  </div>
                  <div
                    className="text-[9px] font-bold uppercase tracking-wider mb-2 opacity-60"
                    style={{ color: T.textMuted }}
                  >
                    {agent.role}
                  </div>
                  {!activeAgent && (
                    <p
                      className="text-[10px] leading-relaxed opacity-60 mb-3 line-clamp-2"
                  ...
                  <div
                    className={`flex flex-wrap gap-1 ${activeAgent ? "hidden" : ""}`}
                  >
                    {agent.tags.map((tag) => (
                      <span
                        key={tag}
                  ...
                  {msgCount > 0 && (
                    <div
                      ...
                      style={{ color: T.textMuted }}
                    >
                      <MessageSquare size={8} /> {msgCount} msg
                      {msgCount > 1 ? "s" : ""}
                    </div>
                  )}
                </div>
        ...
        {activeAgent && (
          <div
            ...
            style={{
              ...
              border: `1.5px solid ${activeAgent.color}30`,
              boxShadow: `0 0 30px ${activeAgent.color}10`,
            }}
          >
            {/* Chat header */}
            <div
            ...
            >
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      border: `1px solid ${msg.role === "user" ? T.accentColor + "40" : activeAgent.color + "40"}`,
                    }}
                  >
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor:
                        msg.role === "user" ? T.accentColor + "10" : T.bgColor,
              ...
              <div
                ref={(el) => {
                  endRefs.current[activeAgent.id] = el;
                }}
              />
            </div>
            ...
            >
              <div className="flex gap-2">
                <input
                  ...
                  onKeyDown={(e) => {
                    if (e.key === "Enter") send(activeAgent.id);
                  }}
              ...
              <div
                className="text-[8px] mt-1.5 opacity-30 text-center"
                style={{ color: T.textMuted }}
              >
