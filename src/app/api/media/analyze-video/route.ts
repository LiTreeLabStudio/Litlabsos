...
async function handler(req: NextRequest) {
    ...
    try {
      ...
      if (!videoBytes) return NextResponse.json({ error: "Missing videoBytes" }, { status: 400 });
      ...
      const response = await ai.models.generateContent({
        ...
        contents: [
          ...
          { text: prompt || "Analyze this video in detail and provide a clean structured summary of the core visible events, actions, dynamic timings, and background audio contexts." },
        ],
      });
