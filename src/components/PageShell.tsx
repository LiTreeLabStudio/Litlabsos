            ...
            {breadcrumbs.map((crumb, i) => (
              <span key={i} className="flex items-center gap-1">
                ...
                {crumb.href ? (
                  ...
                  <span style={{ color: resolvedColors.textMuted }}>
                    {crumb.label}
                  </span>
                )}
              </span>
        ...
        {(title || subtitle) && (
          <div className="mb-8">
                ...
                <div>
                  {title && (
                    <h1
                      ...
                      style={{
                        background: `linear-gradient(90deg, ${resolvedColors.headerColor}, ${resolvedColors.accentColor})`,
            ...
            <div
              className="mt-4 h-px"
              style={{
                background: `linear-gradient(90deg, ${resolvedColors.accentColor}40, transparent)`,
              }}
            />
          </div>
        )}
