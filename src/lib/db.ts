...
const ADMIN_EMAIL = process.env.ADMIN_EMAIL || "connectedlabsceo999@gmail.com";
const ADMIN_PASSWORD_HASH = process.env.ADMIN_PASSWORD_HASH || "$2b$12$R81yeyHAfjsGIk0QnxytvuDPCE4tqhbsRdu/7Hyg8bPnJfhkktisy";
